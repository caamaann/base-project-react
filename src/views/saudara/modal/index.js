...
const index = ({
  ...
  const toggle = () => onSetSaudaraModal("", !isOpenModal);
...
const mapStateToProps = ({ saudara: { isOpenModal, modalType } }) => {
  return { isOpenModal, modalType };
};

const mapDispatchToProps = (dispatch) => {
  return {
    onSetSaudaraModal: (type, isOpen) =>
      dispatch(setSaudaraModal(type, isOpen)),
  };
};
